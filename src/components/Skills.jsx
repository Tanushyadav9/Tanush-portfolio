...
import { Code, Monitor, Server, Database, Cloud, Cpu, Settings, Globe } from 'lucide-react';
import Tilt from './Tilt';

// Premium SVG Technology Icons
const PythonIcon = () => (
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: 'React', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' },
      { name: 'HTML5', styleClass: 'text-purple bg-purple-10 border-purple-20' },
      { name: 'CSS3', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' }
    ]
  },
  {
    title: 'Backend',
    ...
    skills: [
      ...
      { name: 'REST APIs', styleClass: 'text-purple bg-purple-10 border-purple-20' }
    ]
  },
  {
    title: 'Database',
  ...
  },
  {
    ...
    skills: [
      { name: 'Cloud Technologies', styleClass: 'text-purple bg-purple-10 border-purple-20' }
    ]
  },
  {
    title: 'IoT',
    ...
    skills: [
      ...
      { name: 'Embedded Systems', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' }
    ]
  },
  {
    title: 'Tools',
    ...
    skills: [
      { name: 'Git', styleClass: 'text-purple bg-purple-10 border-purple-20' },
      { name: 'GitHub', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' },
      { name: 'VS Code', styleClass: 'text-purple bg-purple-10 border-purple-20' },
      { name: 'Arduino IDE', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' }
    ]
  },
  {
    title: 'Domains',
    ...
    skills: [
      { name: 'Artificial Intelligence', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' },
      { name: 'Machine Learning', styleClass: 'text-purple bg-purple-10 border-purple-20' },
      { name: 'Computer Vision', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' },
      { name: 'IoT', styleClass: 'text-purple bg-purple-10 border-purple-20' },
      { name: 'FinTech', styleClass: 'text-cyan bg-cyan-10 border-cyan-20' },
      { name: 'Smart Automation', styleClass: 'text-purple bg-purple-10 border-purple-20' }
    ]
  }
];
              ...
              <Tilt className="p-6 h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-lg font-bold text-white font-heading text-left">
                      {category.title}
                    </h3>
                  </div>
                    ...
                    {category.skills.map((skill, skillIdx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`px-3 py-1.5 border rounded-xl font-medium text-xs transition-all flex items-center gap-1.5 ${skill.styleClass}`}
                        >
